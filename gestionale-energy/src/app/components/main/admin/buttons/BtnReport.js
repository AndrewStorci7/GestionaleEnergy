...
import ExportReport from "@/app/components/main/admin/export/ExportReport";
...
export default function BtnReport() {
	...
	const COMMON_STYLE =
		"text-black font-semibold bg-sky-50 rounded-full text-sm px-2 py-2 text-center me-2 mb-3.5";
	...
	return (
		<>
			...
			<div className="inline-flex items-center font-thin text-sm opacity-50">
				<Icon type="info" className="!text-gray-400" />I report giornalieri
				fanno riferimento alla data selezionata
			</div>
		</>
	);
}
